...
builder.code = {'pw': pw_code, 'pw2wannier90': pw2wan_code, 'projwfc': projwfc_code, 'wannier90': wan_code}
...
print(f'Use `verdi process list` or `verdi process show {workchain.pk}` to check the progress')
