...
wc_control = {'group_name':'w90wc_trial_1','retrieve_hamiltonian':False,'zero_is_fermi':True}
...
wc = submit(SimpleWannier90WorkChain,
        ...
        restart_options = {'scf_workchain':load_node(9502),'nscf_workchain':load_node(9515),
