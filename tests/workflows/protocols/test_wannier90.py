...
def test_electronic_type(get_wannier90_generator_inputs):
...
def test_spin_type(get_wannier90_generator_inputs):
...
def test_projection_type(get_wannier90_generator_inputs):
