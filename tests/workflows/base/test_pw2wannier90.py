...
def test_prepare_inputs(
    generate_inputs_pw2wannier90_base, generate_workchain_pw2wannier90_base, generate_bands_data,
...
def test_handle_output_stdout_incomplete(
    generate_workchain_pw2wannier90_base, generate_inputs_pw2wannier90_base, npool_key, npool_value
):
