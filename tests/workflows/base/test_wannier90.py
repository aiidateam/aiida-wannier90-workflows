...
def test_prepare_inputs_shift_energy_windows(
    generate_inputs_wannier90_base, generate_workchain_wannier90_base, generate_bands_data, dis_froz_max
):
...
def test_prepare_inputs_auto_energy_windows(
    generate_inputs_wannier90_base, generate_workchain_wannier90_base, generate_bands_data, generate_projection_data
):
...
def test_handle_output_stdout_incomplete(generate_workchain_wannier90_base, generate_inputs_wannier90_base, num_procs):
...
def test_handle_disentanglement_not_enough_states(generate_workchain_wannier90_base, generate_inputs_wannier90_base):
...
def test_handle_plot_wf_cube(generate_workchain_wannier90_base, generate_inputs_wannier90_base):
