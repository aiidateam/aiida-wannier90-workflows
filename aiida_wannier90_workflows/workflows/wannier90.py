...
class Wannier90WorkChain(
    ...
    def get_builder_from_protocol(  # pylint: disable=unused-argument,too-many-statements
        ...
        *,
        ...
        builder["wannier90"] = wannier_builder._inputs(
            prune=True
        ...
        builder["scf"] = scf_builder._inputs(
            prune=True
        )  # pylint: disable=protected-access
        ...
        builder["nscf"] = nscf_builder._inputs(
            prune=True
        )  # pylint: disable=protected-access
        ...
        if run_projwfc:
            ...
            builder["projwfc"] = projwfc_builder._inputs(
                prune=True
            )  # pylint: disable=protected-access
        ...
        builder["pw2wannier90"] = pw2wannier90_builder._inputs(
            prune=True
        )  # pylint: disable=protected-access
