...
def test_scdm(get_bands_generator_inputs, data_regression, serialize_builder):
    """Test ``Wannier90BandsWorkChain.get_builder_from_protocol`` for the default protocol."""

    inputs = get_bands_generator_inputs
...
def test_atomic_projectors_qe(get_bands_generator_inputs, data_regression, serialize_builder):
    """Test ``Wannier90BandsWorkChain.get_builder_from_protocol`` for the default protocol."""
